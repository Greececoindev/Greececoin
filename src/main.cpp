...
uint256 hashGenesisBlock("0x5ee2f9293d9d1e1ff98535e995c2651051adaf3d082e5b0bf6a1c9c4f0e7beb3");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20);
static CBigNum bnStartDifficulty(~uint256(0) >> 28);
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
		...
		// Genesis block
        const char* pszTimestamp = "The Telegraph 08/Mar/2014 - Greece to miss deadline for rescue loan deal";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 1 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04a5814913115273a129cff79907ba4a05d951873d9e7acb6c973d0c9e7c88901a3dbc9aa600deac241b91707e7b4ffb30ad91c8e56e695a1ddf318592988afe0a") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1395490788;
	    ...
	    assert(block.hashMerkleRoot == uint256("0xfadfbc593599f4d116f6805e8b926cfc20dc094f2df45148ecb9ee890f7995bf"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xd0, 0xc3, 0xde, 0xec };
